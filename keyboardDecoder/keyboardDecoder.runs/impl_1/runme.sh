...
HD_PWD='C:/Users/patre/FPGA/keyboardDecoder/keyboardDecoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log keyboard_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source keyboard_TOP.tcl -notrace
