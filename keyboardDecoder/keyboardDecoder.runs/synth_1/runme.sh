...
HD_PWD='C:/Users/patre/FPGA/keyboardDecoder/keyboardDecoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log keyboard_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source keyboard_TOP.tcl
